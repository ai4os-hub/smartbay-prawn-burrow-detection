...
### FILL ME ###
###############
ENV YOLOV8_DEFAULT_WEIGHTS="yolov8_smartbay_prawn_burrow_detection_small"
ENV YOLOV8_DEFAULT_TASK_TYPE="det"

# Uninstall existing module ("yolov8_api")
# Update MODEL_NAME to smartbay_prawn_burrow_detection
...
ENV MODEL_NAME="smartbay_prawn_burrow_detection"
